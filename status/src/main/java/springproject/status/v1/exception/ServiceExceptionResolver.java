package springproject.status.v1.exception;
...
public class ServiceExceptionResolver {
  ...
  public ResponseEntity<Response<Object>> unauthorized(FeignException.Unauthorized exception) {
  ...
  public ResponseEntity<Response<Object>> forbidden(FeignException.Forbidden exception) {
    GlobalException forbidden = GlobalException.FORBIDDEN;
    Response<Object> response =
        Response.builder()
            .code(forbidden.getCode())
  ...
  public ResponseEntity<Response<Object>> forbidden(FeignException.NotFound exception) {
    GlobalException notFound = GlobalException.SERVICE_COMMUNICATION_NOT_FOUND;
    Response<Object> response =
        Response.builder()
            .code(notFound.getCode())
            .message(notFound.getMessage())
            .timestamp(System.currentTimeMillis())
            .build();
    return ResponseEntity.status(notFound.getHttpStatus()).body(response);
  }

  @ExceptionHandler(value = FeignException.class)
  public ResponseEntity<Response<Object>> serviceCommunication(FeignException exception) {
    GlobalException communication = GlobalException.SERVICE_COMMUNICATION;
    Response<Object> response =
        Response.builder()
            ...
            .timestamp(System.currentTimeMillis())
            .build();
    return ResponseEntity.status(communication.getHttpStatus()).body(response);
  }
