...
public class StatusController {
        @Qualifier("jpaStatusService")
        AbstractStatusService jpaStatusService;
        ...
        public ResponseEntity<Response<StatusResponse>> findById(
                ...
                Response<StatusResponse> response = Response.<StatusResponse>builder()
                                .code(ok.getCode())
        ...
        public ResponseEntity<PagingResponse<List<StatusResponse>>> findAll(
                ...
                PagingResponse<List<StatusResponse>> response = PagingResponse.<List<StatusResponse>>builder()
                                .code(ok.getCode())
                                .message(ok.getMessage())
                                .timestamp(System.currentTimeMillis())
        ...
        public ResponseEntity<PagingResponse<List<StatusResponse>>> findAllByContentContains(
                ...
                MultiResource<StatusResponse> queried = jpaStatusService.findAllByContentContains(content, page, size);
