...
public enum GlobalException {
  ...
  SERVICE_COMMUNICATION(
      1, "error occur when communicate between services.", HttpStatus.INTERNAL_SERVER_ERROR),
  SERVICE_COMMUNICATION_NOT_FOUND(
      1, "can not communicate: target endpoint not found.", HttpStatus.INTERNAL_SERVER_ERROR);
